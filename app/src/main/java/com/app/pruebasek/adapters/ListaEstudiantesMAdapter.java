...
public class ListaEstudiantesMAdapter extends FirebaseRecyclerAdapter<Estudiante, ListaEstudiantesMAdapter.ViewHolder>
{

    private EstudianteProvider mEstudianteProvider;
    private Context mContext;
    public ListaEstudiantesMAdapter(@NonNull FirebaseRecyclerOptions<Estudiante> options, Context context) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull final ListaEstudiantesMAdapter.ViewHolder holder, int position, @NonNull Estudiante estudiante)
    {
    ...
    @NonNull
    @Override
    public ListaEstudiantesMAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_lista_estudiantes,parent,false);
        return new ListaEstudiantesMAdapter.ViewHolder(view);
    }
