...
public class ListaEstudiantesAdapter extends FirebaseRecyclerAdapter<Estudiante, ListaEstudiantesAdapter.ViewHolder>
{

    private EstudianteProvider mEstudianteProvider;
    private Context mContext;
    public ListaEstudiantesAdapter(@NonNull FirebaseRecyclerOptions<Estudiante> options, Context context) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull final ListaEstudiantesAdapter.ViewHolder holder, int position, @NonNull Estudiante estudiante)
    {
        ...
        holder.mview.setOnClickListener(new View.OnClickListener() {
            ...
            {
                //Intent intent = new Intent(mContext, EditarMascotaActivity.class);
